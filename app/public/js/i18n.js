...
export const EN_DICT = Object.freeze({
  ...
  '这台电脑上的 claude': 'claude on this computer',
  'MCP 服务器': 'MCP servers',
  '个': '',
  '个可用': 'available',
  ...
  '会花钱的功能': 'Billed features',
  '体检': 'Health check',
  '服务日志': 'Service log',
  'server 进程自己的 stdout / stderr —— 「为什么起不来」的答案在这里': "The server process's own stdout / stderr — where 'why won't it start' is answered",
  '另外三条：会话日志与前端日志在顶栏的运行日志里，安全日志在「服务状态」面板。': 'The other three: session and frontend logs live in the run log in the top bar; the security log is in the Service status panel.',
  '日志': 'Logs',
  '未知路径': 'Unknown path',
