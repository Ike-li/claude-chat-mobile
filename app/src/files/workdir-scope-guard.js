...
// 与 sessions/folder-access.js 的 resolveAuthorizedCwd 分工不同：那边判「这个 cwd 能不能当会话目录」
// （session:new/switch 的 cwd）；本函数判断 cwd 内任意子路径是否越界（供文件浏览/附件等允许用户提供
// 任意子路径的场景），必须 resolve 符号链接——
