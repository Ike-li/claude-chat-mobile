...
export const EN_DICT = Object.freeze({
  ...
  '排队发送': 'Queue send',
  '输入纠偏，当前步骤后发送…': 'Type a correction — sends after the current step…',
  // 「前面已有消息在排队…」已在上方 FE-004 段定义，勿重复 key
  '标准': 'Normal',
  '详细': 'Verbose',
  '摘要': 'Summary',
  '标准：工具卡折叠为摘要（默认）': 'Normal: tool cards collapsed to summaries (default)',
  '详细：展开全部工具与思考（调试用）': 'Verbose: expand all tools and thinking (for debugging)',
  '摘要：只看对话与改动汇总（扫结果）': 'Summary: conversation and change summary only (scan results)',
  '显示：': 'View: ',
  ' · 点按查看 statusline 明细': ' · tap for statusline details',
  '上下文用量': 'Context usage',
  '会话显示密度': 'Transcript density',
  '正在发送…': 'Sending…',
  '正在停止…': 'Stopping…',
  '正在停止': 'Stopping',
  '请稍候…': 'Please wait…',
