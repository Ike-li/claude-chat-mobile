...
export function swiftcArgs({ source, out, target = 'arm64-apple-macos13.0' }) {
  return ['-O', '-parse-as-library', '-target', target, '-framework', 'AppKit', '-o', out, source];
}
...
export function main() {
  ...
  run('swiftc', swiftcArgs({ source: join(DESKTOP, 'ccm-menubar.swift'), out: BINARY }), 'swiftc');
