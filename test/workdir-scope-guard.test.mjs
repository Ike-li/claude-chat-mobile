// test/workdir-scope-guard.test.mjs —— WorkdirScopeGuard 范围判定单测（LLD §3.4.1，承接 AD-12/FR-23）
...
// 范围外的 symlink 即逃逸）；用真实临时目录 + 真实 symlink 测试（同 test/workdirs.test.mjs 的 tmpdir 惯例），
