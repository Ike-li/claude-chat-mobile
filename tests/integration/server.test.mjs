...
const ACK_SHAPES = [
  ...
  { event: 'service:status', payload: () => ({}),
    required: ['ok', 'timestamp', 'startedAt', 'restarts', 'deliveryFailure', 'rateLimitLockout', 'clientError', 'trustedProxyConfigured', 'hooksBridge', 'statuslineBridge', 'logging', 'versions'] },
