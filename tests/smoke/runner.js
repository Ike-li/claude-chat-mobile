...
import { SPAWN_ENV_BLOCKLIST, stripInheritedEnv } from '../helpers/spawn-env.mjs';
...
// 环境隔离清单与集成测共用一份（见 tests/helpers/spawn-env.mjs 的头注：为什么继承环境不干净）。
export { SPAWN_ENV_BLOCKLIST, stripInheritedEnv };
